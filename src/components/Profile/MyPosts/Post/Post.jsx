...
const PostForm = props => {
	return (
		<form onSubmit={props.handleSubmit} className={style.form_comment}>
			<div className={style.footer_input}>
				<Field name='addComment' placeholder='Add a comment...' component='input' />
			</div>
			<div>
				<button className={style.button_post}>Post</button>
			</div>
		</form>
	);
};

const PostFormRedux = reduxForm({ form: "addCommentForm" })(PostForm);
		...
		<div className={style.post_wrapper}>
			<div className={style.post}>
				...
				<div className={style.post_header}>
					<div className={style.post_header_info}>
						<div>
							<img className={style.profile_photo} src={!props.imgProfile ? defaultImg : props.imgProfile} alt='' />
						</div>
						<div>
					...
					<div>
						<svg aria-label='More options' className='_8-yf5 ' fill='#262626' height='18' viewBox='0 0 48 48' width='18' cursor='pointer'>
				...
				{/* post content*/}
				<div className={style.post_wrapperContent}>
					<div className={style.post_content}>
						...
						<div className={style.content_header}>
							...
							<div>{props.currentLikes} likes.</div>
						</div>
						...
						<div className={style.content_footer}>
							<div className={style.footer_form}>
								...
								<PostFormRedux onSubmit={addComment} />
							</div>
						</div>
					</div>
				</div>
