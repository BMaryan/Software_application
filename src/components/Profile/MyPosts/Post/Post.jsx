        ...
        <div className={style.post_wrapper}>
            <div className={style.post}>
                ...
                <div className={style.post_header}>
                    <div><img className={style.profile_photo} src={props.imgProfile} alt=""/></div>
                    <div><a href="" className={style.title}>Maryan Burban</a></div>
                    <div></div>
                </div>

                {/* post cover*/}
                <div className={style.post_cover}><img src={props.imgCover} alt=""/></div>
                    ...
                    <div className={style.post_content}>
                        ...
                        <div className={style.content_body}>
                            <div className={style.body_message}>
                                <span className={style.title}>Maryan Burban</span>{props.message}
                            </div>
                        </div>
