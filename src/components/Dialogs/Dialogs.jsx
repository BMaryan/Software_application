                ...
                <div className={style.dialogs_position}>
                    ...
                    <div className={style.wrapper__messages}>
                        ...
                        <div className={style.create_message}>
                            <div><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQuRJOEamJLWZhmH8AY8iD8EkRyAMkZVOWwA&usqp=CAU" alt=""/></div>
                            <div className={style.message_input} >
                                <input type="text" value={props.dialogsPage.newMessageText} onChange={onMessageChange} placeholder="Write a message..." />
                            </div>
